  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Theme Switcher in Burger Menu ── */}
        <div className="servio-sidebar-theme-row">
          <div className="servio-sidebar-theme-label">
            <span className="servio-sidebar-theme-icon" aria-hidden="true">
              {isDark ? (
          ...
          <div className="servio-theme-segmented" role="radiogroup" aria-label="Theme selection">
            <button
              type="button"
              className={`servio-theme-segment-btn ${!isDark ? 'active' : ''}`}
