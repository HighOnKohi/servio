      ...
      <header className="kitchen-topbar">
        ...
        <div className="kitchen-topbar-right">
          ...
          <button
            ...
            title="Return to Interface Selector"
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 11l-4 4 4 4m0 0l-4-4m4 4H3m18-4a9 9 0 1 1-18 0 9 9 0 0 1 18 0z" /></svg>
            <span>Return</span>
          </button>
        </div>
      </header>
